...
public class SyntaxHrm extends CommonMethods {
    ...
    @Test(groups ="regression",priority = 2,dependsOnMethods = "login")
    public void addUser(){
        //PIM
        ...
        firstName.sendKeys("Rutik1");
        driver.manage().timeouts().implicitlyWait(10, TimeUnit.SECONDS);

        middleName.sendKeys("Rajendra1");
        driver.manage().timeouts().implicitlyWait(10, TimeUnit.SECONDS);

        lastName.sendKeys("Sansare1");
        driver.manage().timeouts().implicitlyWait(10, TimeUnit.SECONDS);

        String id=driver.findElement(By.id("employeeId")).getText();

        //Photograph
        WebElement photograph=driver.findElement(By.id("photofile"));
        photograph.sendKeys("C:\\Users\\rrajendrasansare\\Desktop\\charges.PNG");
        driver.manage().timeouts().implicitlyWait(10, TimeUnit.SECONDS);
        ...
        //Login Details
        WebElement userNm=driver.findElement(By.id("user_name"));
        WebElement passWd=driver.findElement(By.id("user_password"));
        WebElement cmfPassword=driver.findElement(By.id("re_password"));

        userNm.sendKeys("rtksansare1");
        driver.manage().timeouts().implicitlyWait(10, TimeUnit.SECONDS);
        passWd.sendKeys("Autik@28111");
        driver.manage().timeouts().implicitlyWait(10, TimeUnit.SECONDS);
        cmfPassword.sendKeys("Autik@28111");
        driver.manage().timeouts().implicitlyWait(10, TimeUnit.SECONDS);
    ...
    @Test(groups = "regression",priority = 3,dependsOnMethods = "addUser")
